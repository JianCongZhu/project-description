...
set id 358
set name hotspot_HW_fptrunc_64ns_32_2_no_dsp_1
...
set id 359
set name hotspot_HW_fpext_32ns_64_2_no_dsp_1
...
set id 361
set name hotspot_HW_dadddsub_64ns_64ns_64_8_full_dsp_1
...
set id 362
set name hotspot_HW_dmul_64ns_64ns_64_8_max_dsp_1
...
set ID 368
set hasByteEnable 0
set MemName hotspot_HW_top_buf0_0
...
set ID 369
set hasByteEnable 0
set MemName hotspot_HW_result_buf0_0
set CoreName ap_simcore_mem
set PortList { 2 3 }
set DataWd 32
set AddrRange 256
...
set ID 370
set hasByteEnable 0
set MemName hotspot_HW_result_buf0_2
set CoreName ap_simcore_mem
set PortList { 2 0 }
set DataWd 32
set AddrRange 256
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename result \
    op interface \
    ports { result_address0 { O 15 vector } result_ce0 { O 1 bit } result_we0 { O 1 bit } result_d0 { O 512 vector } result_q0 { I 512 vector } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename temp \
    op interface \
    ports { temp_address0 { O 15 vector } temp_ce0 { O 1 bit } temp_we0 { O 1 bit } temp_d0 { O 512 vector } temp_q0 { I 512 vector } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename power \
    op interface \
    ports { power_address0 { O 15 vector } power_ce0 { O 1 bit } power_q0 { I 512 vector } } \
} "
} else {
puts "@W \[IMPL-110\] Cannot find bus interface model in the library. Ignored generation of bus interface for 'power'"
}
}
