    ...
    string AESL_num;{
      ...
      if (rtl_tv_out_file.good()) {
        ...
        if (atoi(AESL_num.c_str()) == AESL_transaction_pc) {
          std::vector<sc_bv<512> > result_pc_buffer(32768);
          int i = 0;
          ...
          if (i > 0) {{
            int i = 0;
            for (int j = 0, e = 32768; j < e; j += 1, ++i) {((long long*)__xlx_apatb_param_result)[j*8+0] = result_pc_buffer[i].range(63,0).to_int64();
((long long*)__xlx_apatb_param_result)[j*8+1] = result_pc_buffer[i].range(127,64).to_int64();
((long long*)__xlx_apatb_param_result)[j*8+2] = result_pc_buffer[i].range(191,128).to_int64();
((long long*)__xlx_apatb_param_result)[j*8+3] = result_pc_buffer[i].range(255,192).to_int64();
((long long*)__xlx_apatb_param_result)[j*8+4] = result_pc_buffer[i].range(319,256).to_int64();
((long long*)__xlx_apatb_param_result)[j*8+5] = result_pc_buffer[i].range(383,320).to_int64();
((long long*)__xlx_apatb_param_result)[j*8+6] = result_pc_buffer[i].range(447,384).to_int64();
((long long*)__xlx_apatb_param_result)[j*8+7] = result_pc_buffer[i].range(511,448).to_int64();
}}}
        } // end transaction
      } // end file is good
    } // end post check logic bolck
  {
      ...
      if (rtl_tv_out_file.good()) {
        ...
        if (atoi(AESL_num.c_str()) == AESL_transaction_pc) {
          std::vector<sc_bv<512> > temp_pc_buffer(32768);
          int i = 0;
          ...
          if (i > 0) {{
            int i = 0;
            for (int j = 0, e = 32768; j < e; j += 1, ++i) {((long long*)__xlx_apatb_param_temp)[j*8+0] = temp_pc_buffer[i].range(63,0).to_int64();
((long long*)__xlx_apatb_param_temp)[j*8+1] = temp_pc_buffer[i].range(127,64).to_int64();
((long long*)__xlx_apatb_param_temp)[j*8+2] = temp_pc_buffer[i].range(191,128).to_int64();
((long long*)__xlx_apatb_param_temp)[j*8+3] = temp_pc_buffer[i].range(255,192).to_int64();
((long long*)__xlx_apatb_param_temp)[j*8+4] = temp_pc_buffer[i].range(319,256).to_int64();
((long long*)__xlx_apatb_param_temp)[j*8+5] = temp_pc_buffer[i].range(383,320).to_int64();
((long long*)__xlx_apatb_param_temp)[j*8+6] = temp_pc_buffer[i].range(447,384).to_int64();
((long long*)__xlx_apatb_param_temp)[j*8+7] = temp_pc_buffer[i].range(511,448).to_int64();
}}}
        } // end transaction
      } // end file is good
    } // end post check logic bolck
...
// print result Transactions
{
  ...
  {  __xlx_offset_byte_param_result = 0*64;
...
__xlx_tmp_lv.range(511,448) = ((long long*)__xlx_apatb_param_result)[j*8+7];
  ...
  tcl_file.set_num(32768, &tcl_file.result_depth);
  sprintf(__xlx_sprintf_buffer.data(), "[[/transaction]] \n");
  aesl_fh.write(AUTOTB_TVIN_result, __xlx_sprintf_buffer.data());
}
unsigned __xlx_offset_byte_param_temp = 0;
// print temp Transactions
{
  sprintf(__xlx_sprintf_buffer.data(), "[[transaction]] %d\n", AESL_transaction);
  aesl_fh.write(AUTOTB_TVIN_temp, __xlx_sprintf_buffer.data());
  {  __xlx_offset_byte_param_temp = 0*64;
...
__xlx_tmp_lv.range(511,448) = ((long long*)__xlx_apatb_param_temp)[j*8+7];
  ...
  tcl_file.set_num(32768, &tcl_file.temp_depth);
  sprintf(__xlx_sprintf_buffer.data(), "[[/transaction]] \n");
  aesl_fh.write(AUTOTB_TVIN_temp, __xlx_sprintf_buffer.data());
}
unsigned __xlx_offset_byte_param_power = 0;
// print power Transactions
{
  sprintf(__xlx_sprintf_buffer.data(), "[[transaction]] %d\n", AESL_transaction);
  aesl_fh.write(AUTOTB_TVIN_power, __xlx_sprintf_buffer.data());
  {  __xlx_offset_byte_param_power = 0*64;
...
__xlx_tmp_lv.range(511,448) = ((long long*)__xlx_apatb_param_power)[j*8+7];
  ...
  tcl_file.set_num(32768, &tcl_file.power_depth);
  sprintf(__xlx_sprintf_buffer.data(), "[[/transaction]] \n");
  aesl_fh.write(AUTOTB_TVIN_power, __xlx_sprintf_buffer.data());
}
