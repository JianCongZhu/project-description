...
// ==============================================================
# 1 "/local-scratch/localhome/cwa230/ensc453_hotspot3D/FPGA/comp-opt/3dHLS.cpp"
# 1 "<built-in>"
# 1 "<command-line>"
...
# 2 "/local-scratch/localhome/cwa230/ensc453_hotspot3D/FPGA/comp-opt/3dHLS.cpp" 2
...
# 3 "/local-scratch/localhome/cwa230/ensc453_hotspot3D/FPGA/comp-opt/3dHLS.cpp" 2
...
# 4 "/local-scratch/localhome/cwa230/ensc453_hotspot3D/FPGA/comp-opt/3dHLS.cpp" 2
...
using std::wcstombs;
using std::wctomb;
# 5 "/local-scratch/localhome/cwa230/ensc453_hotspot3D/FPGA/comp-opt/3dHLS.cpp" 2
...
using std::tgamma;
using std::trunc;
# 6 "/local-scratch/localhome/cwa230/ensc453_hotspot3D/FPGA/comp-opt/3dHLS.cpp" 2
...
# 7 "/local-scratch/localhome/cwa230/ensc453_hotspot3D/FPGA/comp-opt/3dHLS.cpp" 2
...
# 8 "/local-scratch/localhome/cwa230/ensc453_hotspot3D/FPGA/comp-opt/3dHLS.cpp" 2
...
# 9 "/local-scratch/localhome/cwa230/ensc453_hotspot3D/FPGA/comp-opt/3dHLS.cpp" 2
...
void buffer_load(float *dest, float *source)
{
  memcpy(dest, source, sizeof(float) * 64 * 64);
}
...
# 60 "/local-scratch/localhome/cwa230/ensc453_hotspot3D/FPGA/comp-opt/3dHLS.cpp"
    }
}
...
# 118 "/local-scratch/localhome/cwa230/ensc453_hotspot3D/FPGA/comp-opt/3dHLS.cpp"
  int i, j;
  ...
  float top_buf[64 * 64];
  float center_buf[64 * 64];
  float bottom_buf[64 * 64];
  float power_buf[64 * 64];
  float result_buf[64 * 64];
  ...
  for (i = 0; i < 1000 / 2; i++)
  {
    for (j = 0; j < 8; j++)
    {
      ...
      if (j == 0)
      {
        ...
        buffer_load(center_buf, temp + 64 * 64 * j);
        buffer_load(top_buf, temp + 64 * 64 * (j + 1));
        buffer_load(bottom_buf, temp + 64 * 64 * (j));
      }
      else if (j == 8 - 1)
      {
        buffer_load(center_buf, temp + 64 * 64 * j);
        buffer_load(top_buf, temp + 64 * 64 * (j));
        buffer_load(bottom_buf, temp + 64 * 64 * (j - 1));
      }
      else
      {
        buffer_load(center_buf, temp + 64 * 64 * j);
    ...
    for (j = 0; j < 8; j++)
    {
      ...
      if (j == 0)
      {
        buffer_load(center_buf, result + 64 * 64 * j);
        buffer_load(top_buf, result + 64 * 64 * (j + 1));
        buffer_load(bottom_buf, result + 64 * 64 * (j));
      }
      else if (j == 8 - 1)
      {
        buffer_load(center_buf, result + 64 * 64 * j);
        buffer_load(top_buf, result + 64 * 64 * (j));
        buffer_load(bottom_buf, result + 64 * 64 * (j - 1));
      }
      else
      {
        buffer_load(center_buf, result + 64 * 64 * j);
      ...
      buffer_store(temp + 64 * 64 * j, result_buf);
...
extern "C"
#endif
void apatb_hotspot_HW_ir(float *, float *, float *, float, float, float, float, float, float);
#ifdef __cplusplus
extern "C"
#endif
void hotspot_HW_hw_stub(float *result, float *temp, float *power, float Cap, float Rx, float Ry, float Rz, float dt, float amb_temp){
hotspot_HW(result, temp, power, Cap, Rx, Ry, Rz, dt, amb_temp);
return ;
}
#ifdef __cplusplus
extern "C"
#endif
void apatb_hotspot_HW_sw(float *result, float *temp, float *power, float Cap, float Rx, float Ry, float Rz, float dt, float amb_temp){
apatb_hotspot_HW_ir(result, temp, power, Cap, Rx, Ry, Rz, dt, amb_temp);
return ;
}
#endif
# 208 "/local-scratch/localhome/cwa230/ensc453_hotspot3D/FPGA/comp-opt/3dHLS.cpp"
