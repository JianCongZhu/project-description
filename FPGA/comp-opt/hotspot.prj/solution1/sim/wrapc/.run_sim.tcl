...
proc run_exec {fileExe} {
	...
	set ret [catch {eval exec "./$fileExe ../../../../../../data/power_64x8 ../../../../../../data/temp_64x8 | tee tmp.log" >&@ stdout} err]
...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "hotspot_HW.autotvin.dat"
	set constFileTvOut       "hotspot_HW.autotvout.dat"
	set constFileHdlTvIn     "hotspot_HW.autohdltvin.dat"
	set constFileHdlTvOut    "hotspot_HW.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
