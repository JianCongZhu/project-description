...
POWER_PATH = ../../../data/power_16x3
TEMP_PATH = ../../../data/temp_16x3
############################## Setting Targets ##############################
...
$(TEMP_DIR)/hotspot_HW.xo: src/3dHLS.cpp
	mkdir -p $(TEMP_DIR)
	v++ $(VPP_FLAGS) $(VPP_FLAGS_$(MY_KERNEL_NAME)) -c -k hotspot_HW --temp_dir $(TEMP_DIR)  -I'$(<D)' -o'$@' '$<'
#################Make Your Changes Here####################
...
#################Make Your Changes Here####################
$(BUILD_DIR)/$(MY_KERNEL_NAME).xclbin: $(TEMP_DIR)/hotspot_HW.xo
	mkdir -p $(BUILD_DIR)
