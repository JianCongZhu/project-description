...
set ID 38
set hasByteEnable 0
set MemName hotspot_HW_top_buf
...
set ID 39
set hasByteEnable 0
set MemName hotspot_HW_center_buf
set CoreName ap_simcore_mem
set PortList { 2 1 }
set DataWd 32
set AddrRange 4096
...
eval "cg_default_interface_gen_dc { \
    ...
    corename dc_temp \
    op interface \
    ports { temp_i { I 32 vector } temp_o { O 32 vector } temp_o_ap_vld { O 1 bit } } \
} "
}
